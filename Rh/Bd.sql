...
select e.*, p.nom as poste ,t.designation as designation, de.debut as dateEmbauche , e.CIN as matricule,c.salaireBase as salaire from employe as e
left join contrat c on e.id=c.id
