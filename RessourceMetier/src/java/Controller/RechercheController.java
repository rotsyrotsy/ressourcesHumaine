...
public class RechercheController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Employe> listeRecherche=rs.recherche(matricule, poste, contrat, date, salaire);
        request.setAttribute("liste",listeRecherche);
        RequestDispatcher dispat=request.getRequestDispatcher("RechercheEmploye.jsp?recherche=1");
